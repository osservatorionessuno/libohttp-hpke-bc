...
class BouncyCastleHpkeBackend : HpkeBackend {
    override fun setupBaseSender(kemId: Int, kdfId: Int, aeadId: Int, recipientPublicKey: ByteArray, info: ByteArray): HpkeSender {
        ...
        return object : HpkeSender {
            ...
            override fun seal(aad: ByteArray, plaintext: ByteArray) = ctx.seal(aad, plaintext)
            override fun export(exporterContext: ByteArray, length: Int) = ctx.export(exporterContext, length)
        }
    }
}
